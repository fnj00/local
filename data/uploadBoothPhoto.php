...
if(is_numeric($eventid)) {
  ...
  if($result = $mysqli->query($sql1)) {
    if($result->num_rows < $numcollage){
      ...
      do {
        ...
        $checkPhotoNum = "SELECT * FROM photos WHERE eventId = $eventId AND photonum = '$photonum' AND approved = '1'";
  ...
  if (file_exists("../photos/$eventId/$fileName.jpg")) {
    ...
    $sql2 = "INSERT into photos (eventId, approved, filename, photonum) VALUES ('$eventId', '1', '$FileName', '$photonum')";
